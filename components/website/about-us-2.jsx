  ...
  return (
    ...
    <section className="bg-[#3C0C64]/5 border-t-4 border-gray-200/15">
      <div className="mx-auto max-w-7xl px-4 py-20 md:py-24">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-center md:gap-16">
          <div className="md:order-1 -order-1">
            <div className="max-w-lg md:max-w-none">
              ...
              <div className="inline-flex items-center gap-1.5 bg-[#3C0C64]/5 border border-[#3C0C64]/5 rounded-full px-4 py-2">
                ...
                <p className="text-xs text-[#3C0C64] font-medium">
                  Tailored Solutions for Every Client
                </p>
              </div>
              ...
              <p className="mt-4 text-gray-700 text-sm md:text-sm font-medium">
                ...
                time, building wealth as an investor, or simplifying life by
                downsizing, we&apos;ve got you covered. Let&apos;s turn your
                real estate vision into reality—because your dream home deserves
                a dream team!
              </p>
