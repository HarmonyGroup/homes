...
const DeleteListingModal = ({ setModal, onDelete }) => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <h1 className="text-sm font-semibold mt-5">Delete Listing</h1>
          <p className="w-full max-w-sm text-center text-gray-500 leading-5 mt-2">
            You are about to delete a listing. This action cannot be reversed.
          </p>
